...
the case.txt where partial predictions can be observed at a time (Tensorflow
predictions). In this case.txt, we first call the function accumulate many times
...
class AveragePrecisionCalculator(object):
  ...
  def accumulate(self, predictions, actuals, num_positives=None):
    ...
    Args:
      ...
      then it's possible some true positives were missed in them. In that case.txt,
